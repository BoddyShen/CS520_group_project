...
import com.group.AccountService.model.MatchCreateRequest;
...
import com.group.AccountService.documentation.UserApi;
...
public class UserController implements UserApi {
    ...
    @PostMapping("/match")
    public void createMatch(@RequestBody MatchCreateRequest request){
